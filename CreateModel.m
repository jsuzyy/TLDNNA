...
function model=CreateModel()
    %%第一个例子：A1,10 10;A2 15 5;C 25 25;D,N
    %% Create a grid map
    MAP_SIZE = 50;
    ...
    mu2 = [15 5];  % The second distribution/information
    ...
    Pmap =0.9*F1+0.1*F2; % Scale the probability for two information sources about the target
    ...
    model.targetDir = 'N';  % The target moves in East direction 
end